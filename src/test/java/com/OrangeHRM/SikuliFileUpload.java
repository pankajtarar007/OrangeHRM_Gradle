...
public class SikuliFileUpload {
	...
	public void FileUpload_UsingSikuli() throws Exception {
		...
		String spath=filepath+"\\SikuliObjects\\";
		//String inputFilePath = "D:\\F Drive\\Selenium Training Data\\workspace\\Maven_Selenium_WebDriver_4\\Sikuli_Scripts\\";
		Screen s = new Screen();
		Pattern fileInputTextBox = new Pattern(spath+"FileText.png");
		Pattern openButton = new Pattern(spath+"Open.png");
		...
		s.type(fileInputTextBox,spath+"aogo.png");
		s.click(openButton);
